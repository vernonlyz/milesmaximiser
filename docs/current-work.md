...
- **Tests:** engine suite grew to **36** (gate demote/promote, blacklist-no-promote, unconfirmed fallback, no-model ignore, channel-rule guard, MCC-aware pool/channel cap counting, backward-compat).

...
1. **Run pending migrations in Supabase SQL Editor** (required for Miles Balance, favourites, and miles goal to work):
   ...
   - **Migration 077** (latest): `077_citi_rewards_blacklist_extra.sql` — the 14 missing Citi Rewards exclusion MCCs. **Must be run** or those charges still show as bonus-eligible.
